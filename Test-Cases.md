...
| 1.7 | Detect syntax error | The parser can detect if there is a syntax error | The parser outputs an error if an error is found in the assembly code | --- | To test | Medium |
